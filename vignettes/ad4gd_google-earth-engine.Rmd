...
lakes_bb_selected <- readr::read_csv(csv_path, col_types = "c") %>%
  dplyr::left_join(lakes_bb, by = "SEE_KZ")
...
exp_dir <- fs::path_join(c(getwd(), "vignettes/gee/lakes_bb_selected_point_on_surface"))
...
exp_dir <- fs::path_join(c(getwd(), "vignettes/gee/lakes_bb_selected_polygon"))
