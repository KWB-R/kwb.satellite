...
exp_dir <- fs::path_join(c(getwd(), "../vignettes/gee/lakes-berlin_point-malte"))
...
exp_dir <- fs::path_join(c(getwd(), "vignettes/gee/lakes-berlin_point-on-surface"))
fs::dir_create(exp_dir)
...
exp_dir <- fs::path_join(c(getwd(), "../vignettes/gee/lakes-berlin_polygon"))
fs::dir_create(exp_dir)
