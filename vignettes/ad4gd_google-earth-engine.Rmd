...
saveRDS(lakes_bb_point_on_surface, fs::path_join(c(exp_dir, "../lakes-bb_point-on-surface.rds")))
...
lakes_bb_selected_failed <- lakes_bb_selected[lakes_bb_selected$SEE_NAME %in% c("Netzowsee", "Petznicksee"),]
