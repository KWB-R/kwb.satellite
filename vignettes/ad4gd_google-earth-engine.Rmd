...
system.time(
lakes_malte_centroid <- kwb.satellite::gee_get_data_for_years_parallel(
  years = years,
  lakes = lakes_malte,
  centroid = TRUE)
)

fst::write_fst(lakes_malte_centroid, "lakes_malte_centroid.fst")
...
fst::write_fst(lakes_centroid, "lakes_centroid.fst")
...
fst::write_fst(lakes_polygon, "lakes_polygon.fst")
